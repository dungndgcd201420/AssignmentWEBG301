 ...
 */
class getShirtRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ShirtRepository' shared autowired service.
     *
     * @return \App\Repository\ShirtRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ShirtRepository.php';

        return $container->privates['App\\Repository\\ShirtRepository'] = new \App\Repository\ShirtRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
